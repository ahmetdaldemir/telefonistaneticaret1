...
@section('content')
    <div class="modal fade" id="categoryBasic" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog dialog">
            <div class="dialog-content">
                ...
                <h5 class="mb-4" id="ModalTitle">Yeni Kategori Ekle</h5>
                <form method="post" id="categoryForm" action="{{route('category.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-container horizontal">
                        <div class="form-item horizontal">
                            <label class="form-label ltr:pr-2 rtl:pl-2 min-w-[100px]">Kategori Adı:</label>
                            <div class="w-full flex flex-col justify-center relative">
                                <input class="input" id="name" type="text" name="name">
                            </div>
                        </div>
                        <div class="form-item horizontal">
                            <label class="form-label ltr:pr-2 rtl:pl-2 min-w-[100px]">Üst Kategori:</label>
                            <div class="w-full flex flex-col justify-center relative">
                ...
                <div class="card adaptable-card">
                    <div class="card-body">
                        <div class="lg:flex items-center justify-between mb-4">
                            <h3 class="mb-4 lg:mb-0">Kategoriler</h3>
                            <button class="btn btn-two-tune btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#categoryBasic">
                                <span class="flex items-center justify-center gap-2">
                                    ...
                                    <span id="categoryBasic">Yeni Kategori</span>
                                </span>
                            </button>
                        </div>
