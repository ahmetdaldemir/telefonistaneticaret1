                ...
                <div class="card adaptable-card">
                            ...
                            <div class="grid grid-flow-row-dense grid-cols-2 grid-rows-2">
                                <div
                                    ...
                                    <div class="col-span-2">
                                        <div class="card-body">
                                            <h5>Sanalpazar Ozellikleri</h5>

                                            <div class="border rounded-md p-2 max-w-[250px]">
                                                <nav class="menu">
                                                     @foreach($virtual_market_attribute as $item)
                                                    <div class="menu-group">
                                                        <div class="menu-title">{{$item->name}}</div>
                                                        @foreach($item->attributeValues as $values)
                                                          <div class="menu-item">{{$values->name}}</div>
                                                        @endforeach
                                                    </div>
                                                    @endforeach
                                                </nav>
                                            ...
                                            <select id="trendyol-attributes" class="form-control select2">
                                ...
                                <div class="card hover:shadow-lg transition duration-150 ease-in-out card-border cursor-pointer user-select-none"
                                    ...
                                    <div class="col-span-2">
                                        <div class="card-body">
                                            ...
                                            <select id="my-attributes" class="form-control select2">
                    ...
                    <div class="card-body">
                        <div id="DataTable" class="overflow-x-auto">
                            ...
                            <table id="attributedatatable" class="table-default table-hover data-table dataTable no-footer">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Kategori</th>
