                ...
                <div class="mb-6">
                    <div class="flex items-center mb-2">
                        ...
                        <div class="tag border-0 rounded-md ltr:ml-2 rtl:mr-2 bg-emerald-100 text-emerald-600 dark:bg-emerald-500/20 dark:text-emerald-100">
                            {{\App\Models\RepairOrder::ORDER_STATUS_STRINGS[''.$order->status.'']}}
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul>
                                        <li class="flex items-center justify-between mb-3">
                                            <span>Musteri Toplam</span>
                                            <span class="font-semibold">
                                                     <span>{{$order->proforma_total_price}} ₺</span>
                                            </span>
                                        </li>
                                        <li class="flex items-center justify-between mb-3">
                                            <span>Teknik Servis Toplami</span>
                                            <span class="font-semibold">
                                            <span>{{$order->reel_total_price}} ₺</span>
                                        </span>
                                        </li>
                                        <li class="flex items-center justify-between mb-3">
                                            <span>Tax(6%)</span>
                            ...
                            <div class="card-body">
                                <div class="overflow-x-auto">
                                    <div class="card card-border" role="presentation">
                                        <div class="card-body">
                                            <h6 class="truncate mb-4">Musteri Mesaji</h6>
                                            <div class="min-h-[60px]">{!! $order->description  !!}</div>

                                        </div>
                                    </div>
                                    <div class="card card-border" role="presentation">
                                        <div class="card-body">
                                            <h6 class="truncate mb-4">Teknik Servis Mesaji</h6>
                                            <div class="min-h-[60px]">{!! $order->description_price  !!}</div>
                                        ...
                                        <li class="timeline-item">
                                            <div class="timeline-item-wrapper">
                                                ...
                                                <div class="timeline-item-content">
                                                    <div class="font-semibold mb-1 text-base text-emerald-500">{{\App\Models\RepairOrder::ORDER_STATUS_STRINGS[$order_history->value]}}</div>
                        ...
                        <div class="card card-layout-frame" role="presentation">
                            <div class="card-body">
                                ...
                                <address class="not-italic">
                                    ...
                                    <div>{{$order->city->name}} / {{$order->town->name}}</div>
                                </address>
                                <hr class="my-5">
                                <h6 class="mb-4">Fatura Adresi</h6>
                                <address class="not-italic">
                                    <div class="mb-1">1527 Pond Reef Rd</div>
                                    <div class="mb-1">Ketchikan</div>
                                    <div class="mb-1">Alaska 99901</div>
