                                ...
                                <div class="flex flex-col gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select id="categories" name="categories"
                                                class="form-control select2 product-categories">
                                        </select>
                                    </div>
                                    <div class="mt-10">
                                        <label for="category_search">Kategori Adı</label>
                                        <input type="text" class="input" value="{{$category->name}}"
                                               name="category_name" id="category_name">
                                        <p><small class="text-red-500">Seçtiğiniz kategorinin adını buradan
                                                değiştirebilirsiniz</small></p>
                                    </div>
                                    <div>
                                        <label for="category_search">Sıra</label>
                                        <input type="text" class="input" value="{{$category->order}}" name="order"
                                               id="order" value="1">
                                    </div>
                                </div>
                        ...
                        <div class="card adaptable-card">
                            <div class="card-body">
                                <div class="flex flex-col gap-4">
                                    ...
                                    <input class="input input-lg" id="slug" value="{{$category->slug}}" name="slug"
                                           type="text">
                                    <label>
                                        <textarea class="input input-textarea" name="description" id="description"
                                                  placeholder="Açıklama">{{$category->description}}</textarea>
                                        <textarea class="input input-textarea" name="labels" id="labels"
                                                  placeholder="Anahtar Kelimeler">{{$category->labels}}</textarea>
                                    </label>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="basis-1/2   grid justify-center content-between place-items-center">
                                        ...
                                        <label class="switcher place-items-center ">
                                            <input type="checkbox" id="out_category" name="out_category" value="1"
                                                   @if($category->out_category) checked @endif>
                            ...
                            <div class="card-body">
                                <div class="flex flex-col gap-4">
                                    ...
                                    <div class="input-group mb-4">
                                        ...
                                        <button type="button"
                                                class="button bg-white border border-gray-300 dark:bg-gray-700 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 active:bg-gray-100 dark:active:bg-gray-500 dark:active:border-gray-500 text-gray-600 dark:text-gray-100 radius-round h-8 w-8 inline-flex items-center justify-center text-xl">
...
@section('customJS')
    ...
    <script>
        var selectedCategoryId = {{ $category->category_id }};
        var selectedCategoryText = "{!!  $category->generalCategory()[0]['name']  !!}";
        var option = new Option(selectedCategoryText, selectedCategoryId, true, true);
        $('#categories').append(option).trigger('change');
    </script>

    <script>
        var selectedParentCategoryId = {{ $category->parent_id }};
        var selectedParentCategoryText = "{{ $category->parent->name }}";
        var option = new Option(selectedParentCategoryText, selectedParentCategoryId, true, true);
