...
<!-- App Start-->
<div id="root">
    <div id="notification-toast-alert" class="toast-wrapper top-0 left-0 w-full"></div>
                ...
                <header class="header border-b border-gray-200 dark:border-gray-700">
                    <div class="header-wrapper h-16">
                        ...
                        <div class="header-action header-action-end">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu bottom-end">
                                    ...
                                    <li class="menu-item menu-item-hoverable mb-1 justify-between h-[35px]">
												<span class="flex items-center">
													<span class="avatar avatar-circle" data-avatar-size="18">
														<img class="avatar-img avatar-circle" src="img/countries/cn.png"
                                                             loading="lazy" alt="">
													</span>
                                    ...
                                    <li class="menu-item menu-item-hoverable mb-1 justify-between h-[35px]">
												<span class="flex items-center">
													<span class="avatar avatar-circle" data-avatar-size="18">
														<img class="avatar-img avatar-circle" src="img/countries/sp.png"
                                                             loading="lazy" alt="">
													</span>
													<span class="ltr:ml-2 rtl:mr-2">
														Espanol
                                    ...
                                    <li class="menu-item menu-item-hoverable mb-1 justify-between h-[35px]">
												<span class="flex items-center">
													<span class="avatar avatar-circle" data-avatar-size="18">
														<img class="avatar-img avatar-circle" src="img/countries/ar.png"
                                                             loading="lazy" alt="">
													</span>
													<span class="ltr:ml-2 rtl:mr-2">
														Arabic
                            ...
                            <!-- Config-->
                            <div class="text-2xl header-action-item header-action-item-hoverable" data-bs-toggle="modal"
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="input-group">
                                                <button id="dir-ltr-button"
                                                        class="btn bg-gray-100 dark:bg-gray-500 border border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 active:bg-gray-100 dark:active:bg-gray-500 dark:active:border-gray-500 text-gray-600 dark:text-gray-100 radius-round h-9 px-3 py-2 text-sm">
                                                    LTR
                                                </button>
                                                ...
                                                <div class="grid grid-cols-3 gap-4 w-full">
                                                    <div class="text-center" id="layout-classic">
                                                        <div
                                                            ...
                                                            <img src="img/thumbs/layouts/classic.jpg" alt=""
                                                                 class="rounded-md dark:hidden">
                                                            <img src="img/thumbs/layouts/classic-dark.jpg" alt=""
                                                    ...
                                                    <div class="text-center" id="layout-modern">
                                                        <div
                                                            ...
                                                            <img src="img/thumbs/layouts/modern.jpg" alt=""
                                                                 class="rounded-md dark:hidden">
                                                            <img src="img/thumbs/layouts/modern-dark.jpg" alt=""
                                                                 class="rounded-md hidden dark:block">
                                                        </div>
                                                    ...
                                                    <div class="text-center" id="layout-stackedSide">
                                                        <div
                                                            class="flex items-center border rounded-md border-gray-200 dark:border-gray-600 cursor-pointer select-none w-100 hover:ring-1 hover:ring-primary-600 hover:border-primary-600 relative min-h-[80px] w-full">
                                                            <img src="img/thumbs/layouts/stackedSide.jpg" alt=""
                                                                 class="rounded-md dark:hidden">
                                                            <img src="img/thumbs/layouts/stackedSide-dark.jpg" alt=""
                                                                 class="rounded-md hidden dark:block">
                                                        </div>
                                                    ...
                                                    <div class="text-center" id="layout-simple">
                                                        <div
                                                            class="flex items-center border rounded-md border-gray-200 dark:border-gray-600 cursor-pointer select-none w-100 hover:ring-1 hover:ring-primary-600 hover:border-primary-600 relative min-h-[80px] w-full">
                                                            <img src="img/thumbs/layouts/simple.jpg" alt=""
                                                                 class="rounded-md dark:hidden">
                                                            <img src="img/thumbs/layouts/simple-dark.jpg" alt=""
                                                                 class="rounded-md hidden dark:block">
                                                        </div>
                                                    ...
                                                    <div class="text-center" id="layout-decked">
                                                        <div
                                                            class="flex items-center border rounded-md border-gray-200 dark:border-gray-600 cursor-pointer select-none w-100 hover:ring-1 hover:ring-primary-600 hover:border-primary-600 relative min-h-[80px] w-full">
                                                            <img src="img/thumbs/layouts/decked.jpg" alt=""
                                                                 class="rounded-md dark:hidden">
                                                            <img src="img/thumbs/layouts/decked-dark.jpg" alt=""
                                                                 class="rounded-md hidden dark:block">
                                                        </div>
                                        ...
                                        <nav class="menu menu-transparent px-4 pb-4">
                                            <div class="menu-group">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="menu-collapse">
                                                        ...
                                                        <ul>
                                                            <li data-menu-item="classic-crm-dashboard"
                                                                class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-crm-dashboard.html">
                                                                    <span>Dashboard</span>
                                                                </a>
                                                            </li>
                                                            <li data-menu-item="classic-calendar" class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-calendar.html">
                                                                    <span>Calendar</span>
                                                                </a>
                                                            </li>
                                                            <li data-menu-item="classic-customers" class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-customers.html">
                                                                    <span>Customers</span>
                                                                </a>
                                                            </li>
                                                            <li data-menu-item="classic-customer-details"
                                                                class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-customer-details.html">
                                                                    <span>Customer Details</span>
                                                                </a>
                                                            </li>
                                                            <li data-menu-item="classic-mail" class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-mail.html">
                                                                    <span>Mail</span>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <li class="menu-collapse">
                                                        ...
                                                        <ul>
                                                            <li data-menu-item="classic-sales-dashboard"
                                                                class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-sales-dashboard.html">
                                                                    <span>Dashboard</span>
                                                                </a>
                                                            </li>
                                                            <li data-menu-item="classic-product-list" class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-product-list.html">
                                                                    <span>Product List</span>
                                                                </a>
                                                            </li>
                                                            <li data-menu-item="classic-product-edit" class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-product-edit.html">
                                                                    <span>Product Edit</span>
                                                                </a>
                                                            </li>
                                                            <li data-menu-item="classic-new-product" class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-new-product.html">
                                                                    <span>New Product</span>
                                                                </a>
                                                            </li>
                                                            <li data-menu-item="classic-order-list" class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-order-list.html">
                                                                    <span>Order List</span>
                                                                </a>
                                                            </li>
                                                            <li data-menu-item="classic-order-details"
                                                                class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-order-details.html">
                                                    ...
                                                    <li class="menu-collapse">
                                                        ...
                                                        <ul>
                                                            <li data-menu-item="classic-crypto-dashboard"
                                                                class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-crypto-dashboard.html">
                                                                    <span>Dashboard</span>
                                                                </a>
                                                            </li>
                                                            <li data-menu-item="classic-portfolio" class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-portfolio.html">
                                                                    <span>Portfolio</span>
                                                                </a>
                                                            </li>
                                                            <li data-menu-item="classic-market" class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-market.html">
                                                                    <span>Market</span>
                                                                </a>
                                                            </li>
                                                            <li data-menu-item="classic-wallets" class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-wallets.html">
                                                                    <span>Wallets</span>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <li class="menu-collapse">
                                                        ...
                                                        <ul>
                                                            <li data-menu-item="classic-help-center" class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-help-center.html">
                                                                    <span>Help Center</span>
                                                                </a>
                                                            </li>
                                                            <li data-menu-item="classic-article" class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-article.html">
                                                                    <span>Article</span>
                                                                </a>
                                                            </li>
                                                            <li data-menu-item="classic-manage-articles"
                                                                class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-manage-articles.html">
                                                                    <span>Manage Articles</span>
                                                                </a>
                                                            </li>
                                                            <li data-menu-item="classic-edit-article" class="menu-item">
                                                                <a class="h-full w-full flex items-center"
                                                                   href="classic-edit-article.html">
                                            ...
                                            <div class="menu-group">
                                                ...
                                                <ul>
                                                    ...
                                                    <li data-menu-item="classic-access-denied"
                                                        class="menu-item menu-item-single mb-2">
                                            ...
                                            <div class="menu-group">
                                                ...
                                                <ul>
                                                    <li data-menu-item="classic-documentation"
                                                        class="menu-item menu-item-single mb-2">
                                                        <a class="menu-item-link" href="../elstar-html-doc/index.html"
                                                           target="_blank">
																	<span class="menu-item-icon">
																		<svg stroke="currentColor" fill="none"
