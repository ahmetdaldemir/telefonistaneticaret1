...
<section class="small-section small-slider pt-res-0">
    <div class="container">
        <div class="slider-animate home-slider">
            ...
            <div>
                <div class="home">
                    <img src="{{url('https://adminnew.phonehospital.com.tr/storage/slider/'.$slider->img)}}" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain px-padding">
                                    <div>
                                        <h4 class="animated" data-animation-in="fadeInUp">{{$slider->text1}}</h4>
                                        <h1 class="animated" data-animation-in="fadeInUp" data-delay-in="0.3">{{$slider->text2}}</h1>
                                        <a href="{{$slider->url}}" class="btn btn-solid animated" data-animation-in="fadeInUp" data-delay-in="0.5">Satın Al</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row margin-default">
                <div class="col-xl-3 col-sm-6 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>500 TL ve uzeri ucretsiz kargo</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 service-block">
                ...
                <div class="col-xl-3 col-sm-6 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>Supriz Indirimler</h4>
                            <p>Binlerce urunde indirimli fiyatlar</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>Online Odeme</h4>
                            <p>SSL Sertifikasi , bilgileriniz guvende</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="title-basic">
                    <h2 class="title"><i class="ti-bolt"></i>AYIN FIRSATLARI</h2>
                    <div class="timer">
                        <p id="demo"></p>
                    </div>
                </div>
                        ...
                        <a href="{{$banner->url}}">
                            <div class="collection-banner tl-content">
                                <div class="img-part custom-height">
                                    <img src="{{url('https://adminnew.phonehospital.com.tr/storage/banner/'.$banner->img)}}" class="img-fluid blur-up lazyload bg-img" alt="">
                                </div>
                ...
                <div class="col-lg-3 col-12 d-lg-block d-none">
                    <div class="banner-goggles banner-padding pt-0">
                        ...
                        <a href="#">
                            <div class="collection-banner tl-content">
                                <div class="img-part custom-height">
                                    <img  src="{{url('https://adminnew.phonehospital.com.tr/storage/banner/'.$banner->img)}}"
                    ...
                    @foreach($brands as $brand)
                      <div  style="width: 125px;height: 125px" >
                          <div class="logo-block">
                              <a href="#">
                                  @if(!is_null($brand->img))
                                  <img style="height: 125px"  src="{{asset('https://adminnew.phonehospital.com.tr/storage/brand/'.$brand->img)}}" alt="">
                                  @else
                                 <img src="{{url('https://eticaret.phonehospital.com.tr/ecommerce/images/logos/8.png')}}" alt="">
                                  @endif
                              </a>
                          </div>
                      </div>
