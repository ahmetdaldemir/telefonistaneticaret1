        ...
        <div class="container mx-auto">
            <div class="grid grid-flow-col justify-stretch ">
                     <div class="card adaptable-card">
                        <div class="card-body">
                            <form class="needs-validation" method="post" action="{{route('supervisor.store')}}" novalidate>
                                @csrf
                                <div class="form-container vertical">
                                    <div class="grid grid-flow-row-dense grid-cols-2 grid-rows-1">
                                        <div class="p-4">
                                            ...
                                            <input id="validationCustomEmail" class="input form-control" name="title" value="{{old('title')}}" type="text">
                                        </div>
                                        <div class="p-4">
                                            <label class="form-label mb-2" for="validationCustomUsername">Kep Adresi</label>
                                            <input id="validationCustomUsername" class="input form-control" name="kep_address" value="{{old('kep_address')}}"  type="text">
                                        </div>
                                        <div class="p-4">
                                            <label class="form-label mb-2" for="validationCustomUsername">Mersis No</label>
                                            <input id="validationCustomUsername" class="input form-control"  name="mersis_address" value="{{old('mersis_address')}}"  type="text">
                                        </div>
                                        <div class="p-4">
                                            <label class="form-label mb-2" for="validationCustomUsername">Vergi Dairesi</label>
                                            <input id="validationCustomUsername" class="input form-control"  name="tax_office" value="{{old('tax_office')}}"  type="text">
                                        </div>
                                        <div class="p-4">
                                            <label class="form-label mb-2" for="validationCustomUsername">Vergi No</label>
                                            <input id="validationCustomUsername" class="input form-control" name="tax_number" value="{{old('tax_number')}}"  type="text">
                                        </div>
                                        <div class="p-4">
                                            <label class="form-label mb-2" for="validationCustomUsername">Şirket Ünvanı</label>
                                            <input id="validationCustomUsername" class="input form-control" name="company_name" value="{{old('company_name')}}"  type="text">
                                        </div>
                                        <div class="p-4">
                                            <label class="form-label mb-2" for="validationCustomUsername">Şirket Türü</label>
                                            <input id="validationCustomUsername" class="input form-control" name="company_type" value="{{old('company_type')}}"  type="text">
                                        </div>
                                        <div class="p-4">
                                            <label class="form-label mb-2" for="validationCustomUsername">Site Adresi</label>
                                            <input id="validationCustomUsername" class="input form-control" name="website" value="{{old('website')}}"  type="text">
                                        </div>
                                    </div>
                                    <div class="grid grid-flow-row-dense grid-cols-1 grid-rows-3">
                                        <div class="p-4">
                                            ...
                                            <input id="validationCustomUsername" class="input form-control"  name="invoice_address" value="{{old('invoice_address')}}"  />
                                        </div>
                                        <div class="p-4">
                                            <label class="form-label mb-2" for="validationCustomUsername">Sevkiyat Adresi</label>
                                            <input id="validationCustomUsername" class="input form-control"  name="shipping_address" value="{{old('shipping_address')}}"  />
                                        </div>
                                        <div class="p-4">
                                            <label class="form-label mb-2" for="validationCustomUsername">İade Adresi</label>
                                            <input id="validationCustomUsername" class="input form-control"  name="return_address" value="{{old('return_address')}}"  />
                                        </div>
                                    </div>
                                    <div class="grid grid-flow-row-dense grid-cols-3 grid-rows-1">
                                        <div class="p-4">
                                            ...
                                            <select id="validationCustomEmail" name="slider_size" class="input form-control">
