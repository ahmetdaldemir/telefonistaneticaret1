    ...
    <main class="cpr__models-repairs">
        ...
        <section id="models-repairs-list" class="cpr__models-repairs--list">
            ...
            <div class="cpr__models-repairs--item">
                <img src="{{asset('repair/assets/img/home/14series.webp')}}" alt="{{$item->name}} Teknik Servis" id="image_models_repairs_3">
                <h2 class="cpr__models-repairs--item-title">{{$item->name}} </br> Teknik Servis</h2><a class="cpr__models-repairs--item-link"  href="{{route('model',['id' => $item->id,'name' => $item->name])}}" title="Model Seçiniz" aria-label="Model Seçiniz">
                    <label class="cpr__btn-lbl">Model Seçiniz</label>
