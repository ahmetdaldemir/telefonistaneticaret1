...
<style>
    ...
    margin: 10px 0px 20px 0px;">VEYA</div>
                    <form class="cpr__booking-customer-form--content cpr__form" href="{{route('registerSave')}}">
                        ...
                        <div class="cpr__booking-search-input--content">
                            <input type="text" class="cpr__booking-search--input no-highlight" placeholder="Email">
                        </div>
                        <div class="cpr__booking-search-input--content">
                            <input type="text" class="cpr__booking-search--input no-highlight" placeholder="Şifre">
                        </div>
