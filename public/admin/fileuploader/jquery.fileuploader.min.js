 ...
 */!function (e) {
    ...
    $.fn.fileuploader = function (q) {
        return this.each(function (t, r) {
                    ...
                    init: function () {
                        ...
                        if (f.clipboard._timer && f.clipboard.clean(), !f.isDefaultMode() || (f.reset(), 0 != i.length)) {
                            ...
                            for (var r = 0, a = 0; a < i.length; a++) {
                                var d = i[a], u = f._itFl[f.files.add(d, "choosed")], d = f.files.check(u, i, 0 == a);
                                if (!0 === d) n.thumbnails && f.thumbnails.item(u), f.isUploadMode() && f.upload.prepare(u), n.onSelect && $.isFunction(n.onSelect) && n.onSelect(u, l, p, o, s), r++; else if (f.files.remove(u, !0), d[2] || (f.isDefaultMode() && (f.set("input", ""), f.reset(), d[3] = !0), d[1] && f._assets.dialogs.alert(d[1], u, l, p, o, s)), d[3]) break
                            }
                        ...
                        create: function () {
                            ...
                            l = e.is(n.thumbnails._selectors.list) ? e : e.find(n.thumbnails._selectors.list), n.thumbnails._selectors.popup_open && l.on("click", n.thumbnails._selectors.popup_open, function (e) {
                                e.preventDefault();
                                e = $(this).closest(n.thumbnails._selectors.item), e = f.files.find(e);
                                e && e.popup && e.html.hasClass("file-has-popup") && f.thumbnails.popup(e)
                                ...
                                if (e.preventDefault(), f.locked) return !1;
                                e = $(this).closest(n.thumbnails._selectors.item), e = f.files.find(e);
                                e && e.editor && (e.editor.rotate(), e.editor.save())
                            }), n.thumbnails._selectors.remove && l.on("click", n.thumbnails._selectors.remove, function (e) {
                                if (e.preventDefault(), f.locked) return !1;
                                var e = $(this).closest(n.thumbnails._selectors.item), t = f.files.find(e),
                                    e = function (e) {
                                        f.files.remove(t)
                                    };
                                t && (t.upload && "successful" != t.upload.status ? f.upload.cancel(t) : n.thumbnails.removeConfirmation && !t.choosed ? f._assets.dialogs.confirm(f._assets.textParse(n.captions.removeConfirmation, t), e) : e())
                            })
                        }, clear: function () {
                            l && l.html("")
                        }, item: function (t, e) {
                            ...
                            var o = '<div style="${style}" class="fileuploader-item-icon${class}"><i>' + (t || "") + "</i></div>",
                                t = f._assets.textToColor(t);
                            return t && (f._assets.isBrightColor(t) && (o = o.replace("${class}", " is-bright-color")), o = o.replace("${style}", "background-color: " + t)), o.replace("${style}", "").replace("${class}", "")
                        }, renderThumbnail: function (d, e, t) {
                            function u(e) {
                                e = $(e), h.removeClass("fileuploader-no-thumbnail fileuploader-loading").html(e), d.html.hasClass("file-will-popup") && d.html.removeClass("file-will-popup").addClass("file-has-popup"), e.is("img") && e.attr("draggable", "false").on("load error", function (e) {
                                    "error" == e.type && m()
                            ...
                            function c() {
                                var e = 0;
                                if (d && -1 < f._pfrL.indexOf(d)) for (f._pfrL.splice(f._pfrL.indexOf(d), 1); e < f._pfrL.length;) {
                            ...
                            var h = d.html.find(".fileuploader-item-image"),
                                i = d.data && (d.data.readerSkip || !1 === d.data.thumbnail), m = function () {
                            ...
                            if (h.length) {
                                if (d.image = h.html("").addClass("fileuploader-loading"), (-1 < ["image", "video", "audio", "astext"].indexOf(d.format) || d.data.thumbnail) && f.isFileReaderSupported() && !i && (d.appended || n.thumbnails.startImageRenderer || e)) {
                                    ...
                                    var r = function (e, t) {
                                        function o() {
                                            var e;
                                            n.thumbnails.canvasImage ? (e = document.createElement("canvas"), f.editor.resize(this, e, n.thumbnails.canvasImage.width || h.width(), n.thumbnails.canvasImage.height || h.height(), !1, !0), f._assets.isBlankCanvas(e) ? m() : u(e)) : u(this), c()
                                        }
                                        ...
                                        var r = e && e.nodeName && "img" == e.nodeName.toLowerCase(), a = r ? e.src : e,
                                            l = null;
                            ...
                            !f.locked && n.thumbnails.popup && n.thumbnails._selectors.popup && (a = $(n.thumbnails.popup.container), u = a.find(".fileuploader-popup"), e = function () {
                                function t(e) {
                                    27 == (e = e.which || e.keyCode) && d.popup && d.popup.close && d.popup.close(), 37 != e && 39 != e || !n.thumbnails.popup.arrows || d.popup.move(37 == e ? "prev" : "next")
                                }
                                ...
                                u.removeClass("loading"), u.children(n.thumbnails._selectors.popup).length && ($.each(f._itFl, function (e, t) {
                                    ...
                                    var t = f._itFl.indexOf(d), o = null, i = !1;
                                    if ("prev" == (e = n.thumbnails.itemPrepend ? "prev" == e ? "next" : "prev" : e)) for (var r = t; 0 <= r; r--) {
                                        if ((a = f._itFl[r]) != d && a.popup && a.html.hasClass("file-has-popup")) {
                                            o = a;
                                            break
                                        }
                                        0 != r || o || i || !n.thumbnails.popup.loop || (r = f._itFl.length, i = !0)
                                    } else for (var a, r = t; r < f._itFl.length; r++) {
                                        if ((a = f._itFl[r]) != d && a.popup && a.html.hasClass("file-has-popup")) {
                                            o = a;
                                            break
                                        }
                        ...
                        rotate: function (e, t, o) {
                            ...
                            if (!(e.popup && e.popup.html && $("html").find(e.popup.html).length)) {
                                var n = e.editor.rotation || 0, r = t || n + 90;
                                return 360 <= r && (r = 0), e.popup.editor && (e.popup.editor.rotation = r), e.editor.rotation = r
                            }
                            e.popup.node && (e.popup.editor.isAnimating || (e.popup.editor.isAnimating = !0, i = e.popup.html.find(".fileuploader-popup-node").find(".reader-node"), a = i.find("> img"), r = {
                                rotation: n = e.popup.editor.rotation || 0,
                                scale: e.popup.editor.scale || 1
                            }, e.popup.editor.cropper && e.popup.editor.cropper.$template.hide(), e.popup.editor.rotation = o ? t : n + 90, e.popup.editor.scale = (i.height() / a[-1 < [90, 270].indexOf(e.popup.editor.rotation) ? "width" : "height"]()).toFixed(3), a.height() * e.popup.editor.scale > i.width() && -1 < [90, 270].indexOf(e.popup.editor.rotation) && (e.popup.editor.scale = i.height() / a.width()), 1 < e.popup.editor.scale && (e.popup.editor.scale = 1), $(r).stop().animate({
                                rotation: e.popup.editor.rotation,
                                scale: e.popup.editor.scale
                            }, {
                                duration: o ? 2 : 300, easing: "swing", step: function (e, t) {
                                    var o = a.css("-webkit-transform") || a.css("-moz-transform") || a.css("transform") || "none",
                                        i = 0, n = 1, r = t.prop;
                                    "none" !== o && (o = (t = o.split("(")[1].split(")")[0].split(","))[0], t = t[1], i = "rotation" == r ? e : Math.round(Math.atan2(t, o) * (180 / Math.PI)), n = "scale" == r ? e : Math.round(10 * Math.sqrt(o * o + t * t)) / 10), a.css({
                            ...
                            var t, l, o;
                            if (!(m.popup && m.popup.html && $("html").find(m.popup.html).length)) return m.editor.crop = e || m.editor.crop;
                            m.popup.node && (m.popup.editor.cropper ? (e && (m.popup.editor.cropper.crop = e), m.popup.editor.cropper.init(e)) : (t = m.popup.html.find(".fileuploader-popup-node .reader-node > img"), o = (l = $('<div class="fileuploader-cropper"><div class="fileuploader-cropper-area"><div class="point point-a"></div><div class="point point-b"></div><div class="point point-c"></div><div class="point point-d"></div><div class="point point-e"></div><div class="point point-f"></div><div class="point point-g"></div><div class="point point-h"></div><div class="area-move"></div><div class="area-image"></div><div class="area-info"></div></div></div>')).find(".fileuploader-cropper-area"), m.popup.editor.cropper = {
                                $imageEl: t,
                                $template: l,
                                $editor: o,
                                isCropping: !1,
                                crop: e || null,
                                init: function (t) {
                                    var o = m.popup.editor.cropper, e = o.$imageEl.position(),
                                        i = o.$imageEl[0].getBoundingClientRect().width,
                                        r = o.$imageEl[0].getBoundingClientRect().height,
                                        a = m.popup.editor.rotation && -1 < [90, 270].indexOf(m.popup.editor.rotation) ? m.popup.editor.scale : 1;
                                    if (o.hide(), o.crop || o.setDefaultData(), 0 == i || 0 == r) return o.hide(!0);
                                    o.isCropping || (o.$imageEl.clone().appendTo(o.$template.find(".area-image")), o.$imageEl.parent().append(l)), o.$template.hide().css({
                                        left: e.left,
                                        top: e.top,
                                        width: i,
                                        height: r
                                ...
                                resize: function (e) {
                                    ...
                                    }, 500)) : (o.crop.cfWidth = i.width() / m.reader.width, o.crop.cfHeight = i.height() / m.reader.height))
                                },
                                drawPlaceHolder: function (e) {
                                    var t = m.popup.editor.cropper, o = m.popup.editor.rotation || 0,
                                        i = m.popup.editor.scale || 1, n = [0, 0];
                                ...
                                setAreaInfo: function (e) {
                                    var t = m.popup.editor.cropper, o = m.popup.editor.scale || 1;
                            ...
                            var a = t.getContext("2d"), o = !o && i ? i * e.width / e.height : o,
                                i = !i && o ? o * e.height / e.width : i, l = e.width / e.height,
                                s = 1 <= l ? o : i * l, l = l < 1 ? i : o / l;
                            r && s < o && (l *= o / s, s = o), r && l < i && (s *= i / l, l = i);
                            var p = Math.min(Math.ceil(Math.log(e.width / s) / Math.log(2)), 12);
                            if (t.width = s, t.height = l, e.width < t.width || e.height < t.height || p < 2) {
                                r || (t.width = Math.min(e.width, t.width), t.height = Math.min(e.height, t.height));
                                i = e.width < t.width ? (t.width - e.width) / 2 : 0, r = e.height < t.height ? (t.height - e.height) / 2 : 0;
                                n || (a.fillStyle = "#fff", a.fillRect(0, 0, t.width, t.height)), a.drawImage(e, i, r, Math.min(e.width, t.width), Math.min(e.height, t.height))
                            } else {
                                var d = document.createElement("canvas"), u = d.getContext("2d"), c = 2;
                                for (d.width = e.width / c, d.height = e.height / c, u.fillStyle = "#fff", u.fillRect(0, 0, d.width, d.height), u.imageSmoothingEnabled = !1, u.imageSmoothingQuality = "high", u.drawImage(e, 0, 0, d.width, d.height); 2 < p;) {
                                    var f = c + 2, h = e.width / c, m = e.height / c;
                                    h > d.width && (h = d.width), m > d.height && (m = d.height), u.imageSmoothingEnabled = !0, u.drawImage(d, 0, 0, h, m, 0, 0, e.width / f, e.height / f), c = f, p--
                                }
                                h = e.width / c, m = e.height / c;
                                h > d.width && (h = d.width), m > d.height && (m = d.height), a.drawImage(d, 0, 0, h, m, 0, 0, s, l), d = u = null
                            }
                            a = null
                        }, zoomer: function (s) {
                            var e, p, d, l;
                            s.popup && s.popup.html && $("html").find(s.popup.html).length && (s.popup.zoomer || (e = s.popup.html, p = e.find(".fileuploader-popup-node"), d = p.find(".reader-node"), l = d.find("> img").attr("draggable", "false").attr("ondragstart", "return false;"), s.popup.zoomer = {
                                ...
                                mousedown: function (e) {
                                    ...
                                    var o = s.popup.zoomer, i = $(e.target),
                                        r = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                        a = {
                                            x: ("mousedown" == r ? e : e.originalEvent.touches[0]).pageX,
                                            y: ("mousedown" == r ? e : e.originalEvent.touches[0]).pageY
                                        };
                                    ...
                                    }, n.thumbnails.touchDelay || 0)), $(document).on("mouseup touchend", o.mouseup))
                                },
                                mousemove: function (e) {
                                    var t = s.popup.zoomer,
                                        o = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                        i = ("mousedown" == o ? e : e.originalEvent.touches[0]).pageX,
                                        e = ("mousedown" == o ? e : e.originalEvent.touches[0]).pageY,
                                        i = i - t.pointData.xTarget, e = e - t.pointData.yTarget;
                                    0 < e && (e = 0), e < p.height() - d.height() && (e = p.height() - d.height()), d.height() < p.height() && (e = p.height() / 2 - d.height() / 2), d.width() > p.width() ? (0 < i && (i = 0), i < p.width() - d.width() && (i = p.width() - d.width())) : i = p.width() / 2 - d.width() / 2, d.css({
                                        left: (t.left = i) + "px",
                                        top: (t.top = e) + "px"
                                    })
                                },
                                ...
                                zoomIn: function (e) {
                                    var t = s.popup.zoomer, e = e || 20;
                                    100 <= t.zoom || (t.zoom = Math.min(100, t.zoom + e), t.updateView(t.zoom))
                                },
                                zoomOut: function (e) {
                                    var t = s.popup.zoomer, e = e || 20;
                                    t.zoom <= t.scale || (t.zoom = Math.max(t.scale, t.zoom - e), t.updateView(t.zoom))
                                },
                                updateView: function (e, t) {
                                    var o = this, i = o.getImageSize().width / 100 * e,
                                        n = o.getImageSize().height / 100 * e, r = d.width(), a = d.height(),
                                        l = e && e != o.scale;
                            ...
                            function e() {
                                if (v.reader.node) {
                                    var e, t, i, r = document.createElement("canvas"), a = r.getContext("2d"),
                                        d = [0, 180], u = w || v.type || "image/jpeg", c = n.editor.quality || 90,
                                        h = function (e, t) {
                                            var i = e;
                                            b && (i ? i = f._assets.dataURItoBlob(i, u) : console.error("Error: Failed to execute 'toDataURL' on 'HTMLCanvasElement': Tainted canvases may not be exported.")), !y && i && f.thumbnails.renderThumbnail(v, !0, t || e), x && x(i, v, l, p, o, s), null != n.editor.onSave && "function" == typeof n.editor.onSave && n.editor.onSave(i, v, l, p, o, s), f.set("listInput", null)
                                        };
                                    try {
                                        r.width = v.reader.width, r.height = v.reader.height, a.drawImage(this, 0, 0, v.reader.width, v.reader.height), void 0 !== v.editor.rotation && (v.editor.rotation = v.editor.rotation || 0, r.width = -1 < d.indexOf(v.editor.rotation) ? v.reader.width : v.reader.height, r.height = -1 < d.indexOf(v.editor.rotation) ? v.reader.height : v.reader.width, i = v.editor.rotation * Math.PI / 180, e = .5 * r.width, t = .5 * r.height, a.clearRect(0, 0, r.width, r.height), a.translate(e, t), a.rotate(i), a.translate(.5 * -v.reader.width, .5 * -v.reader.height), a.drawImage(this, 0, 0), a.setTransform(1, 0, 0, 1, 0, 0)), v.editor.crop && (i = a.getImageData(v.editor.crop.left, v.editor.crop.top, v.editor.crop.width, v.editor.crop.height), r.width = v.editor.crop.width, r.height = v.editor.crop.height, a.putImageData(i, 0, 0));
                                        var m, g = r.toDataURL(u, c / 100);
                                        n.editor.maxWidth || n.editor.maxHeight ? ((m = new Image).src = g, m.onload = function () {
                                            var e = document.createElement("canvas");
                                            f.editor.resize(m, e, n.editor.maxWidth, n.editor.maxHeight, !0, !1), g = e.toDataURL(u, c / 100), r = a = e = null, h(g, m)
                                        }) : (r = a = null, h(g))
                                    } catch (e) {
                                        v.popup.editor = null, r = a = null, h(null)
                                    }
                                }
                            }

                            var t = v.popup && v.popup.html && $("html").find(v.popup.html).length, i = new Image;
                            if (t) {
                                if (!v.popup.editor.hasChanges) return;
                                t = v.popup.editor.scale || 1;
                                v.editor.rotation = v.popup.editor.rotation || 0, v.popup.editor.cropper && (v.editor.crop = v.popup.editor.cropper.crop, v.editor.crop.width = v.editor.crop.width / v.popup.editor.cropper.crop.cfWidth / t, v.editor.crop.left = v.editor.crop.left / v.popup.editor.cropper.crop.cfWidth / t, v.editor.crop.height = v.editor.crop.height / v.popup.editor.cropper.crop.cfHeight / t, v.editor.crop.top = v.editor.crop.top / v.popup.editor.cropper.crop.cfHeight / t)
                            }
                            f._assets.isMobile() ? (i.onload = e, i.src = v.reader.src) : v.popup.node ? e.call(v.popup.node) : v.reader.node ? e.call(v.reader.node) : v.reader.read(v, function () {
                        ...
                        init: function () {
                            ...
                            var e = f.sorter.sort, e = e.items.not(e.item.html), i = null;
                            return e.each(function (e, t) {
                                t = $(t);
                                if (o.x > t.offset().left && o.x < t.offset().left + t.outerWidth() && o.y > t.offset().top && o.y < t.offset().top + t.outerHeight()) return i = t, !1
                            }), i
                        }, mousedown: function (e) {
                            function t() {
                                f.sorter.sort = {
                            ...
                            var o = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                i = $(e.target), r = i.closest(n.thumbnails._selectors.item), a = f.files.find(r), s = {
                                    x: ("mousedown" != o && r.length ? e.originalEvent.touches[0] : e).pageX,
                                    y: ("mousedown" != o && r.length ? e.originalEvent.touches[0] : e).pageY
                                };
                            ...
                            var t = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                o = f.sorter.sort, i = o.item, r = l.find(n.thumbnails._selectors.item),
                                a = $(n.sorter.scrollContainer || window), s = $(document).scrollLeft(),
                                p = $(document).scrollTop(), d = a.scrollLeft(), u = a.scrollTop(), c = {
                                    x: ("mousedown" == t ? e : e.originalEvent.touches[0]).clientX,
                                    y: ("mousedown" == t ? e : e.originalEvent.touches[0]).clientY
                                }, h = c.x - o.xItem, m = c.y - o.yItem, t = c.x - (a.prop("offsetLeft") || 0),
                                e = c.y - (a.prop("offsetTop") || 0);
                            h + o.xItem > a.width() && (h = a.width() - o.xItem), h + o.xItem < 0 && (h = 0 - o.xItem), m + o.yItem > a.height() && (m = a.height() - o.yItem), m + o.yItem < 0 && (m = 0 - o.yItem), e <= 0 && a.scrollTop(u - 10), e > a.height() && a.scrollTop(u + 10), t < 0 && a.scrollLeft(d - 10), t > a.width() && a.scrollLeft(d + 10), i.html.addClass("sorting").css({
                                position: "fixed",
                                left: h,
                                top: m,
                            ...
                            if (s) {
                                m = o.placeholder.offset().left != s.offset().left, p = o.placeholder.offset().top != s.offset().top;
                                if (f.sorter.sort.lastHover && f.sorter.sort.lastHover.el == s[0]) {
                                    if (p && "before" == f.sorter.sort.lastHover.direction && c.y < f.sorter.sort.lastHover.y) return;
                                    if (p && "after" == f.sorter.sort.lastHover.direction && c.y > f.sorter.sort.lastHover.y) return;
                                    if (m && "before" == f.sorter.sort.lastHover.direction && c.x < f.sorter.sort.lastHover.x) return;
                                    if (m && "after" == f.sorter.sort.lastHover.direction && c.x > f.sorter.sort.lastHover.x) return
                                }
                                m = r.index(i.html), m = r.index(s) < m ? "before" : "after";
                                s[m](o.placeholder), s[m](i.html), f.sorter.sort.lastHover = {
                                    el: s[0],
                                    x: c.x,
                                    y: c.y,
                                    direction: m
                            ...
                            $.each(t, function (e, t) {
                                ...
                                t && (t.upload && !t.uploaded || (f.rendered && t.index != r && (f._itSl && f._itSl.indexOf(t.id), 1) && (i = !0), t.index = r, a.push(t), d.push(t.id), r++))
                        ...
                        prepare: function (t, e) {
                            ...
                            }, t.upload.formData.append(s.attr("name"), t.file, t.name || !1), (n.upload.start || e) && f.upload.send(t, e)
                        }, send: function (a, e) {
                            if (a.upload) {
                                var t, d = function (e) {
                                    ...
                                    var e = 0;
                                    if (0 < f._pfuL.length) for (-1 < f._pfuL.indexOf(a) && f._pfuL.splice(f._pfuL.indexOf(a), 1); e < f._pfuL.length;) {
                                ...
                                if (n.upload.synchron && !a.upload.chunk) if (a.upload.status = "pending", a.html && d(), e) -1 < f._pfuL.indexOf(a) && f._pfuL.splice(f._pfuL.indexOf(a), 1); else if (-1 == f._pfuL.indexOf(a) && f._pfuL.push(a), 1 < f._pfuL.length) return;
                                if (n.upload.chunk && a.file.slice && (t = f._assets.toBytes(n.upload.chunk), 1 < (e = Math.ceil(a.size / t, t)) && !a.upload.chunk && (a.upload.chunk = {
                                    name: a.name,
                                    size: a.file.size,
                                    type: a.file.type,
                                    chunkSize: t,
                                    ...
                                    total: e,
                                    i: -1
                                }), a.upload.chunk && (a.upload.chunk.i++, delete a.upload.chunk.isFirst, delete a.upload.chunk.isLast, 0 == a.upload.chunk.i && (a.upload.chunk.isFirst = !0), a.upload.chunk.i == a.upload.chunk.total - 1 && (a.upload.chunk.isLast = !0), a.upload.chunk.i <= a.upload.chunk.total - 1 ? (e = a.upload.chunk.i * a.upload.chunk.chunkSize, e = a.file.slice(e, e + a.upload.chunk.chunkSize), a.upload.formData = new FormData, a.upload.formData.append(s.attr("name"), e), a.upload.data._chunkedd = JSON.stringify(a.upload.chunk)) : delete a.upload.chunk)), n.upload.beforeSend && $.isFunction(n.upload.beforeSend) && !1 === n.upload.beforeSend(a, l, p, o, s)) return delete a.upload.chunk, d(), void r();
                                if (p.addClass("fileuploader-is-uploading"), a.upload.$ajax && a.upload.$ajax.abort(), delete a.upload.$ajax, delete a.upload.send, a.upload.status = "loading", a.html && (n.thumbnails._selectors.start && a.html.find(n.thumbnails._selectors.start).remove(), d()), a.upload.data) for (var i in a.upload.data) a.upload.data.hasOwnProperty(i) && a.upload.formData.append(i, a.upload.data[i]);
                                a.upload.data = a.upload.formData, a.upload.xhrStartedAt = a.upload.chunk && a.upload.chunk.xhrStartedAt ? a.upload.chunk.xhrStartedAt : new Date, a.upload.xhr = function () {
                                    ...
                                    }, a.html && d(), null != n.upload.onSuccess && $.isFunction(n.upload.onSuccess) && n.upload.onSuccess(e, a, l, p, o, s, t, i), f.set("listInput", null); else try {
                                        var r = JSON.parse(e);
                            ...
                            !e && r && t.upload.$ajax && (e = {
                                ...
                                lengthComputable: !0
                            }), e.lengthComputable && (m = new Date, a = e.loaded + (t.upload.chunk ? t.upload.chunk.loaded : 0), d = t.upload.chunk ? t.upload.chunk.size : e.total, u = Math.round(100 * a / d), g = t.upload.chunk && t.upload.chunk.xhrStartedAt ? t.upload.chunk.xhrStartedAt : i, h = (c = (m.getTime() - g.getTime()) / 1e3) ? a / c : 0, m = Math.max(0, d - a), g = Math.max(0, c ? m / h : 0), g = {
                                loaded: a,
                        ...
                        add: function (e, t) {
                            var o, r, i = e._name || e.name, a = e.size, l = f._assets.bytesToText(a), p = e.type,
                            ...
                            return (h = {
                                ...
                                rotate: !1 !== n.editor.rotation ? function (e) {
                                    f.editor.rotate(r, e)
                                } : null, cropper: !1 !== n.editor.cropper ? function (e) {
                                    f.editor.crop(r, e)
                            ...
                            if (f.isFileReaderSupported() && !d.data.readerSkip) {
                                var a = new FileReader, u = window.URL || window.webkitURL, c = r && d.data.thumbnail,
                                    h = "string" != typeof d.file, m = function () {
                                ...
                                if ("astext" == d.format) a.onload = function (e) {
                                    ...
                                    if (a.onload = function (e) {
                                        function o() {
                                            d.data && d.data.readerCrossOrigin && l.setAttribute("crossOrigin", d.data.readerCrossOrigin), l.src = e.target.result + (!d.data.readerForce && !i || h || c || -1 != e.target.result.indexOf("data:image") ? "" : (-1 == e.target.result.indexOf("?") ? "?" : "&") + "d=" + Date.now()), l.onload = function () {
                                                if (d.reader.exifOrientation) {
                                                    var e = document.createElement("canvas"), t = e.getContext("2d"),
                                                        o = l, i = Math.abs(d.reader.exifOrientation),
                                                    ...
                                                    var a = i * Math.PI / 180, r = .5 * e.width, i = .5 * e.height;
                                                    return t.clearRect(0, 0, e.width, e.height), t.translate(r, i), t.rotate(a), t.translate(.5 * -o.naturalWidth, .5 * -o.naturalHeight), n && (-1 < [-1, -180].indexOf(n) ? (t.translate(e.width, 0), t.scale(-1, 1)) : -1 < [-90, -270].indexOf(n) && (t.translate(0, e.width), t.scale(1, -1))), t.drawImage(o, 0, 0), t.setTransform(1, 0, 0, 1, 0, 0), l.src = e.toDataURL(d.type, 1), void delete d.reader.exifOrientation
                                                }
                                                d.reader.node = l, d.reader.src = l.src, d.reader.width = l.width, d.reader.height = l.height, d.reader.ratio = f._assets.pxToRatio(d.reader.width, d.reader.height), v && u.revokeObjectURL(v), m(), c && (d.reader = {read: d.reader.read})
                                            }, l.onerror = function () {
                                                m(), d.reader = {read: d.reader.read}
                                            }
                                        }
                                        ...
                                        n.thumbnails.exif && d.choosed ? f._assets.getExifOrientation(d.file, function (e) {
                                            var t;
                                            e && ("Chrome" == (t = f._assets.getDevice.init()).browser.name && 81 <= t.browser.version ? delete d.reader.exifOrientation : d.reader.exifOrientation = e), o()
                                        }) : o()
                                    }, a.onerror = function () {
                                        m(), d.reader = {read: d.reader.read}
                                    }, !c && d.size > f._assets.toBytes(n.reader.maxSize)) return a.onerror();
                                    h ? n.thumbnails.useObjectUrl && n.thumbnails.canvasImage && u ? a.onload({target: {result: v = u.createObjectURL(d.file)}}) : a.readAsDataURL(d.file) : a.onload({target: {result: c ? d.data.thumbnail : d.file}})
                                ...
                                } else "application/pdf" == d.type && n.thumbnails.pdf && !t ? (g = document.createElement("iframe"), v = h ? u.createObjectURL(d.file) : d.file, (n.thumbnails.pdf.viewer || f._assets.hasPlugin("pdf")) && (g.src = (n.thumbnails.pdf.viewer || "") + v, d.reader.node = g, d.reader.src = v), m()) : (a.onload = function (e) {
                            ...
                            var o;
                            -1 == f._itFl.indexOf(e) || e.upload && e.upload.$ajax || (o = e, t = f.files.add($.extend(e, t), "updated"), (e = f._itFl[t]).popup && e.popup.close && e.popup.close(), n.thumbnails && o.html && f.thumbnails.item(e, o.html), f.set("listInput", null))
                        }, find: function (o) {
                            var i = null;
                            ...
                            }), a && (f.isAddMoreMode() && 1 < sl.length ? (f.set("nextInput"), sl.splice(sl.indexOf(i.input), 1), i.input.remove()) : f.set("input", ""))), -1 < f._pfrL.indexOf(i) && f._pfrL.splice(f._pfrL.indexOf(i), 1), -1 < f._pfuL.indexOf(i) && f._pfuL.splice(f._pfuL.indexOf(i), 1), -1 < f._itFl.indexOf(i) && f._itFl.splice(f._itFl.indexOf(i), 1), i = null, 0 == f._itFl.length && f.reset(), f.set("feedback", null), f.set("listInput", null))
                        },selected: function (i, r) {
                            var a;
                            !r && n.onSelected && $.isFunction(n.onSelected) && !1 === n.onSelected(i, l, p, o, s) || (i.html && (n.thumbnails.onItemSelected && $.isFunction(n.thumbnails.onItemSelected) && !r ? n.thumbnails.onItemSelected(i.html, l, p, o, s) : i.html.selected()), i.upload && i.upload.$ajax && i.upload.cancel && i.upload.cancel(!0), i.popup && i.popup.close && (i.popup.node = null, i.popup.close()), i.reader.src && (i.reader.node = null, URL.revokeObjectURL(i.reader.src)), i.input && (a = !0, $.each(f._itFl, function (e, t) {
                                if (i != t && (i.input == t.input || r && 1 < i.input.get(0).files.length)) return a = !1
                            }), a && (f.isAddMoreMode() && 1 < sl.length ? (f.set("nextInput"), sl.splice(sl.indexOf(i.input), 1), i.input.selected()) : f.set("input", ""))), -1 < f._pfrL.indexOf(i) && f._pfrL.splice(f._pfrL.indexOf(i), 1), -1 < f._pfuL.indexOf(i) && f._pfuL.splice(f._pfuL.indexOf(i), 1), -1 < f._itFl.indexOf(i) && f._itFl.splice(f._itFl.indexOf(i), 1), i = null, 0 == f._itFl.length && f.reset(), f.set("feedback", null), f.set("listInput", null))
                        ...
                        toBytes: function (e) {
                            ...
                            var t = Math.floor(Math.log(e) / Math.log(1024)), o = e / Math.pow(1024, t), i = !1;
                            ...
                            var t = document.createElement("canvas"), o = !1;
                            ...
                            for (var o = atob(e.split(",")[1]), i = e.split(",")[0].split(":")[1].split(";")[0], e = new ArrayBuffer(o.length), n = new Uint8Array(e), r = 0; r < o.length; r++) n[r] = o.charCodeAt(r);
                            e = new DataView(e);
                            return new Blob([e.buffer], {type: t || i})
                        }, getExifOrientation: function (e, p) {
                            var t = new FileReader, d = {1: 0, 2: -1, 3: 180, 4: -180, 5: -90, 6: 90, 7: -270, 8: 270};
                            t.onload = function (e) {
                                var t = new DataView(e.target.result), o = 1;
                                if (t.byteLength && 65496 == t.getUint16(0, !1)) for (var i = t.byteLength, n = 2; n < i && !(t.getUint16(n + 2, !1) <= 8);) {
                                    ...
                                    if (n += 2, 65505 == r) {
                                        ...
                                        for (var s = 0; s < a; s++) if (274 == t.getUint16(n + 12 * s, l)) {
                            ...
                            dataos: [{name: "Windows Phone", value: "Windows Phone", version: "OS"}, {
                                name: "Windows",
                                value: "Win",
                                version: "NT"
                            ...
                            databrowser: [{name: "Chrome", value: "Chrome", version: "Chrome"}, {
                                name: "Firefox",
                                value: "Firefox",
                                version: "Firefox"
                            ...
                            matchItem: function (e, t) {
                                for (var o, i, n, r = 0, a = 0, r = 0; r < t.length; r += 1) if (new RegExp(t[r].value, "i").test(e)) {
                                    if (o = new RegExp(t[r].version + "[- /:;]([\\d._]+)", "i"), n = "", (i = e.match(o)) && i[1] && (i = i[1]), i) for (i = i.split(/[._]+/), a = 0; a < i.length; a += 1) n += 0 === a ? i[a] + "." : i[a]; else n = "0";
            ...
            return n.enableApi && (s.get(0).FileUploader = {
                open: function () {
                    ...
                    return !!f.isUploadMode() && ((t = e instanceof Blob ? e : (e = /data:[a-z]+\/[a-z]+\;base64\,/.test(e) ? e : "data:" + t + ";base64," + btoa(e), f._assets.dataURItoBlob(e, t)))._name = o || f._assets.generateFileName(-1 != t.type.indexOf("/") ? t.type.split("/")[1].toString().toLowerCase() : "File "), f.onChange(null, [t]), !0)
                }, append: function (e) {
                    return f.files.append(e)
                }, update: function (e, t) {
                    return f.files.update(e, t)
                }, selected: function (e) {
                    return e = e.jquery ? f.files.find(e) : e, -1 < f._itFl.indexOf(e) && (f.files.selected(e), !0)
                },  remove: function (e) {
        ...
        getInstance: function (e) {
            e = e.prop ? e : $(e);
            return e.length ? e.get(0).FileUploader : null
        }
      ...
      en: {
        ...
        thumbnails: {
            ...
            boxAppendTo: null,
            item: '<li class="fileuploader-item"><div class="columns"><div class="column-thumbnail">${image}<span class="fileuploader-action-popup"></span></div><div class="column-title"><div title="${name}">${name}</div><span>${size2}</span></div><div class="column-actions"><button data-title="${name}" type="button" class="fileuploader-action fileuploader-action-selected" title="${captions.selected}">Seç</button><button type="button" class="fileuploader-action fileuploader-action-remove" title="${captions.remove}"><i class="fileuploader-icon-remove"></i></button></div></div><div class="progress-bar2">${progressBar}<span></span></div></li>',
            item2: '<li class="fileuploader-item"><div class="columns"><div class="column-thumbnail">${image}<span class="fileuploader-action-popup"></span></div><div class="column-title"><a href="${file}" target="_blank"><div title="${name}">${name}</div><span>${size2}</span></a></div><div class="column-actions"><a href="${data.url}" class="fileuploader-action fileuploader-action-download" title="${captions.download}" download><i class="fileuploader-icon-download"></i></a><button  data-name="${name}" type="button" class="fileuploader-action fileuploader-action-selected" title="${captions.selected}">Seç</button><button type="button" class="fileuploader-action fileuploader-action-remove" title="${captions.remove}"><i class="fileuploader-icon-remove"></i></button></div></div></li>',
            popup: {
                container: "body", loop: !0, arrows: !0, zoomer: !0, template: function (e) {
            ...
            _selectors: {
                ...
                selected: ".fileuploader-action-selected",
